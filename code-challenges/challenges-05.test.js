...
const addPurchases = (arr) => {
  // Solution code here...
  const sumPurchase = arr.reduce((acc, currValue) => acc + currValue.purchasePrice ,0);
  return sumPurchase;
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  const countOfElements = arr.reduce((acc) => acc + 1 ,0);
...
const returnNames = (arr) => {
  // Solution code here...
  const name = arr.reduce((acc, currentValue) =>{
...
const reversedString = (str) => {
  ...
  const name = arrayOfChars.reduce((acc, currentValue) =>{
